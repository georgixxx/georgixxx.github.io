<div style="display: flex; gap: 40px; align-items: flex-start; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #333;">
  ...
  <div style="flex: 2; padding-right: 10px;">
    ...
    <div style="background-color: #ffffff; padding: 20px; border-left: 4px solid #004a99; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
      ...
      <p style="line-height: 1.5;">Developing Python-driven insights (Pandas/NumPy) to transform validated logs into automated weekly KPI reports and visualizations.</p>
    </div>
